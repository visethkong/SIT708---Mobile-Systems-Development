...
import com.example.chatsystem.Adapters.ChatAdapter;
import com.example.chatsystem.Models.ChatMessage;
import com.example.chatsystem.Models.User;
import com.example.chatsystem.Network.ApiClient;
import com.example.chatsystem.Network.ApiService;
import com.example.chatsystem.Utilities.Constants;
import com.example.chatsystem.Utilities.PreferenceManager;
import com.example.chatsystem.databinding.ActivityInboxBinding;
...
public class InboxActivity extends BaseActivity {
    ...
    private void listenAvailabilityOfReceiver() {
        database.collection(Constants.KEY_COLLECTION_USERS).document(
                receiverUser.id
        ).addSnapshotListener(InboxActivity.this, (value, error) -> {
            if(error != null) {
                return;
            }
            if(value != null) {
